...
export const dynoIconsBySize: Readonly<Record<string, vscode.ThemeIcon>> = {
  ...
  'Standard-1X': new vscode.ThemeIcon('hk-icon-dynomite-1x-16', themeColor),
  'Standard-2X': new vscode.ThemeIcon('hk-icon-dynomite-2x-16', themeColor),
  '1X-Classic': new vscode.ThemeIcon('hk-icon-dynomite-1x-16', themeColor),
  '2X-Classic': new vscode.ThemeIcon('hk-icon-dynomite-2x-16', themeColor),
